		...
		<div class="tab-content noline">
			<div class="tab-pane active" id="avatarSetting">
				...
				<div class="row-fluid center">	
					<h4>头像预览</h4>
					<p><img id='headpicPreviewImg' class="headpicPreview" src="${jypath}/static/images/system/user/hpic1.jpg"></p>
					<p>头像100*100</p>
			...
			<form id="perfileSettingFrom" method="POST" onsubmit="return false;">
				<div class="profile-user-info profile-user-info-striped">
					...
					<div class="profile-info-row">
						...
						<div class="profile-info-value tab-pane-right">
							<div class="clearfix">
								<input type="text" jyValidate="email" id='perDataEmail' maxlength="120" name='email' class="col-xs-12">
							</div>
						</div>
					</div>
				</div>
