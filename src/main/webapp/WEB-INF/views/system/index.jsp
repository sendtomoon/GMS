...
<script type="text/javascript"
	src="${jypath}/static/js/jquery/jquery.cookie.js"></script>
<link rel="stylesheet"
	href="${jypath}/static/css/system/bootstrap/bootstrap.min.css" />
<link rel="stylesheet"
	href="${jypath}/static/css/system/ace/font-awesome.min.css" />
<link rel="stylesheet"
	href="${jypath}/static/css/system/jquery/jquery-ui-1.10.3.full.min.css"
	type="text/css" />
<link rel="stylesheet"
	href="${jypath}/static/css/system/bootstrap/bootstrap-responsive.min.css" />
<!-- ace styles -->
<link rel="stylesheet"
	href="${jypath}/static/css/system/ace/ace.min.css" />
<link type="text/css" rel="stylesheet"
	href="${jypath}/static/css/system/ace/ace-rtl.min.css" />
<link type="text/css" rel="stylesheet"
	href="${jypath}/static/css/system/ace/ace-responsive.min.css" />
<link type="text/css" rel="stylesheet"
	href="${jypath}/static/css/system/ace/ace-skins.min.css" />
<link type="text/css" rel="stylesheet"
	href="${jypath}/static/plugins/tabs/css/tab-control.min.css" />
<link type="text/css" rel="stylesheet"
	href="${jypath}/static/css/system/system/index.css" />
		...
		<div class="navbar-container" id="navbar-container">
			<div class="navbar-header pull-left" >
				<span class="navbar-brand" > <!--  -->
					 <img alt="" src="${jypath}/static/images/main/logo_title.png"
				...
				<div style="margin: 0; padding-top: 5px; background-color: #fff;">
					<div class="tab-control">
						<div class="tab simple">
							<form>
								<input class="prev" type="button" /> <input class="next"
									type="button" /> <input class="find" type="button" />
							</form>
							<ul class="tabul"></ul>
						</div>
						<!-- 标签查找 -->
