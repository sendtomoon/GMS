...
public class Const
{
	 ...
	 *用户状态：失效状态 0
	 */
	public static final String USER_STATE_INACTIVE = "0";
	
	/**
	 * 机构等级（0_公司）
	 */
	public static final String ORG_GRADE_COMPANY = "0";
	
	/**
	 * 机构等级（1_部门）
	 */
	public static final String ORG_GRADE_DEPT = "1";
	
	/**
	 * 机构等级（4_门店）
	 */
	public static final String ORG_GRADE_STORE = "4";
	
	/**
	 * 持久层目标方法前缀
	 */
	public static final String TARGET_METHOD_PREFIX = "dataFilter_";
