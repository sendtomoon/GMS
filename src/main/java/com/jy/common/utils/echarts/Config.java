...
public interface Config
{
    ...
    public static final String[] color = { "#ff7f50", "#87cefa", "#da70d6", "#32cd32", "#6495ed", "#ff69b4", "#ba55d3", "#cd5c5c", "#ffa500", "#40e0d0", "#1e90ff", "#ff6347", "#7b68ee", "#00fa9a", "#ffd700", "#6699FF", "#ff6666", "#3cb371", "#b8860b", "#30e0e0" };
    public static final Integer DRAG_ENABLE_TIME = 120;
    public static final Integer EFFECT_ZLEVEL = 7;
    public static final String[] symbolList = { "circle", "rectangle", "triangle", "diamond", "emptyCircle", "emptyRectangle", "emptyTriangle", "emptyDiamond" };
    public static final String loadingText = "Loading...";
    public static final Boolean calculable = false;
    ...
    public static final Boolean addDataAnimation = true;
    public static final Integer animationThreshold = 2000;
    public static final Integer animationDuration = 2000;
