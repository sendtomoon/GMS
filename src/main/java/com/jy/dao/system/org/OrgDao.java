...
public interface OrgDao extends BaseDao<Org>{
     ...
     * @return
     */
	public List<ZNodes> getOrgTree(String orgId);
	/**
     * 获取上级机构树
     * @return
     */
	...
	public List<ZNodes> getOrgTreeE4(String orgId);
	
	public List<ZNodes> getOrgNode(String id);
	 ...
	 * @return
	 */
	public int findOrgRecordByCode(@Param("code")String code);
